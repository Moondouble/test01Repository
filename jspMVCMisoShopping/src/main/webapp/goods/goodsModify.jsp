...
<table border=1 align="center" width="600">
	...
	<tr><th>상품설명</th>
		<td><textarea rows="10" cols="45" name="goodsContent"value="${dto.goodsContent }"></textarea></td></tr>
	<tr><th>조회수</th>
	...
	<tr><th>마지막 수정일</th>
		<td><input type="text" name="goodsUpdateDate" value="${goodsUpdateDate }" readonly="readonly"></td></tr>
	<tr><th colspan="2">
