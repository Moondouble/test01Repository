	...
	<c:if test="${!empty auth }">
		<ul>
			<c:if test="${auth.grade == 'emp' }">
				...
				<li><a href="employeeMyPage.my">직원 내정보 보기</a></li>
...
<table width = "800" align="center">
   <tr>
      ...
      <td><a href="detailView.item?goodsNum=${dto.goodsNum }"><img src="goods/upload/${dto.goodsMainImage }" width="300" height="150"><br>
         상품명 ${dto.goodsName }<br>
         상품가격 ${dto.goodsPrice }<br>
         </a>
      </td>
   </tr><c:if test="${idx.count % 3 == 0 }"><tr></c:if>
      </c:forEach>
</table>
</body>
</html>
